export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'mooltiplydms',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Mooltiplydms',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'mooltiplydms.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://mooltiplydms.com',
