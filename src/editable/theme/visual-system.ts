...
export const visualPresets = {
  ...
  'tech-directory': {
    ...
    shape: 'dark glass cards, rounded corners, subtle glow',
  },
  'retro-bulletin': {
...
export const visualSystem = {
  ...
  typography: {
    ...
    heroTitle: 'text-5xl font-bold tracking-[-0.04em] sm:text-6xl lg:text-7xl',
  ...
  surfaces: {
    ...
    paper: 'border border-white/[0.06] bg-[#111827] shadow-[0_24px_70px_rgba(0,0,0,0.4)]',
    quiet: 'border border-white/[0.06] bg-white/[0.02]',
    dark: 'border border-white/[0.06] bg-[#060a15] shadow-[0_24px_70px_rgba(0,0,0,0.5)]',
  },
  layout: {
